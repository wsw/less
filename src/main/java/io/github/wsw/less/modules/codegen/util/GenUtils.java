package io.github.wsw.less.modules.codegen.util;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.CharsetUtil;
import cn.hutool.core.util.StrUtil;
import io.github.wsw.less.common.exception.LessException;
import io.github.wsw.less.modules.codegen.entity.ColumnEntity;
import io.github.wsw.less.modules.codegen.entity.GenConfig;
import io.github.wsw.less.modules.codegen.entity.TableEntity;
...
public class GenUtils {
    ...
    public void generatorCode(GenConfig genConfig, Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new LessException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
            }
        }
    }
    ...
    private Configuration getConfig() {
        try {
            ...
            throw new LessException("获取配置文件失败，", e);
        }
    }
